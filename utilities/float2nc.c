...
#define ERRCODE 2
#define ERR(e) {free(data_buf); fprintf(stderr, "Error: %s\n", nc_strerror(e)); exit(ERRCODE);}
...
int main( int argc, char** argv )
{
    ...
    /* Define the variable. The type of the variable in this case is NC_FLOAT (4-byte float). */
    ...
    /* Write the  data to the file. In this case we write all the data in one operation. */
