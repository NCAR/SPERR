...
int main(int argc, char *argv[])
{
  ...
  if (QccWAVklttce3DDecodeHeader(&InputBuffer,
                                 &NumLevels,
                                 &NumFrames,
                                 &NumRows,
                                 &NumCols,
                                 ...
                                 &Alpha))
    {
      QccErrorAddMessage("%s: Error calling QccWAVklttce3DDecodeHeader()",
                         argv[0]);
      QccErrorExit();
    }
  ...
  if (QccWAVklttce3DDecode(&InputBuffer,
                           &OutputImage,
                           NumLevels,
                           Alpha,
                           &Wavelet,
                           ...
                           TargetBitCnt))
    {
      QccErrorAddMessage("%s: Error calling QccWAVklttce3DDecode()",
                         argv[0]);
      QccErrorExit();
    }
