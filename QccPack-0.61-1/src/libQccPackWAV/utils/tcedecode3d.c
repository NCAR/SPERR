...
int main(int argc, char *argv[])
{
  ...
  if (QccWAVtce3DDecodeHeader(&InputBuffer,
                              &TransformType,
                              &TemporalNumLevels,
                              &SpatialNumLevels,
                              &NumFrames,
                              ...
                              &Alpha))
    {
      QccErrorAddMessage("%s: Error calling QccWAVtce3DDecodeHeader()",
                         argv[0]);
      QccErrorExit();
    }
  ...
  if (QccWAVtce3DDecode(&InputBuffer,
                        &OutputImage,                        
                        TransformType,
                        TemporalNumLevels,
                        SpatialNumLevels,
                        ...
                        TargetBitCnt))
    {
      QccErrorAddMessage("%s: Error calling QccWAVtce3DDecode()", argv[0]);
      QccErrorExit();
    }
