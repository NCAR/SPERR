...
{ 
  ...
  if (QccWAVbisk3DDecodeHeader(&InputBuffer,
                               &TransformType,
                               &TemporalNumLevels,
			       &SpatialNumLevels,
			       &NumFrames,
			       ...
			       &NumCols,	
                               ...
                               &MaxCoefficientBits))
    {
      QccErrorAddMessage("%s: Error calling QccWAVbiskDecodeHeader3D()",
                         argv[0]);
      QccErrorExit();
    }
  ...
  if (QccWAVbisk3DDecode(&InputBuffer,
                         &OutputImage,
