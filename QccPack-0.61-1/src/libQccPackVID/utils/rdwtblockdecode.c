...
int main(int argc, char *argv[])
{
  ...
  if (QccVIDRDWTBlockDecodeHeader(&InputBuffer,
                                  &NumRows,
                                  &NumCols,
                                  ...
                                  &TargetBitCnt))
    {
      QccErrorAddMessage("%s: Error calling QccVIDRDWTBlockDecodeHeader()",
                         argv[0]);
      QccErrorExit();
    }
  ...
  if (QccVIDRDWTBlockDecode(&ImageSequence,
                            ((FilterSpecified1) ?
                             &Filter1 : NULL),
                            ((FilterSpecified2) ?
                             &Filter2 : NULL),
                            ...
                            Quiet))
    {
      QccErrorAddMessage("%s: Error calling QccVIDRDWTBlockDecode()",
			 argv[0]);
      QccErrorExit();
    }
