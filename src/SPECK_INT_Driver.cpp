...
template <typename T>
void sperr::SPECK_INT_Driver::copy_data(const T* p, size_t len)
{
...
template void sperr::SPECK_INT_Driver::copy_data(const double*, size_t);
template void sperr::SPECK_INT_Driver::copy_data(const float*, size_t);

void sperr::SPECK_INT_Driver::take_data(sperr::vecd_type&& buf)
{
