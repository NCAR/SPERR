...
auto sperr::partition_S_XYZ(const Set3D& set) -> std::array<Set3D, 8>
{
...
auto sperr::partition_S_XY(const Set3D& set) -> std::array<Set3D, 4>
{
...
auto sperr::partition_S_Z(const Set3D& set) -> std::array<Set3D, 2>
{
